...
#滑块
popularity_filter = st.slider('pop', 0.0, 100.0, 40.0)
...
#表1;哪一种音乐类型的流行度更广？
st.subheader('The relationship between genre and popularity of popular songs')
...
st.subheader('Evaluate the popularity of popular music every year')
fig, ax = plt.subplots(figsize=(5, 5))
